...
def get_dataset(cfg):
    trainset = Customdataset(cfg,istrain=True)
    if cfg.ngpu>1:
    ...
    valset = Customdataset(cfg,istrain=False)
    if cfg.ngpu>1:
